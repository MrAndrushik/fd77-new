            ...
            <section className="privacy">
                <div className="container">
                    ...
                    <p className="privacy__text">
                        ...
                        fud-trak77.ru персональных данных: сбор,
                    ...
                    <p className="privacy__text">
                        Компания fud-trak77.ru гарантирует конфиденциальность
                        ...
                        fud-trak77.ru в качестве обязательных к исполнению.
                    </p>
                    <p className="privacy__text">
                        ...
                        fud-trak77.ru гарантирует, что правообладатель,
                    ...
                    <p className="privacy__text">
                        ...
                        info@fud-trak77.ru копию зареннного нотариусом письма
                    ...
                    <p className="privacy__text">
                        ...
                        (https://fud-trak77.ru/), а также уничтожение
                        записей, содержащих ваши персональные данные, в системах
                        обработки персональных данных компании fud-trak77.ru,
                        что может сделать невозможным пользование
                        интернет-сервисами компании fud-trak77.ru.
                    </p>
                    <p className="privacy__text">
