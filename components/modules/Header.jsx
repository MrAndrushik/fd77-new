...
const Header = () => {
    ...
    const navLinks = [
        ...
        },
        {
            ...
            Component: <Nav2 />,
            text: "Аренда мебели (скоро будет)",
        },
        {
            href: KULINARNYE_STANCII_ROUTE,
            Component: <Nav3 />,
            text: "Кулинарные станции (скоро будет)",
        },
        {
            href: ARENDA_SHATROV_ROUTE,
            Component: <Nav4 />,
            text: "Киоски, шатры (скоро будет)",
        },
        {
            href: MASTER_CLASS_ROUTE,
            Component: <Nav5 />,
            text: "Мастер-классы (скоро будет)",
        },
        {
            href: PRODAZHA_FUDTRAKOV_ROUTE,
            Component: <Nav6 />,
            text: "Купить фудтрак (скоро будет)",
        },
    ];
                ...
                <div ref={headerTopRef} className={"header-top"}>
                    ...
                    >
                        ...
                        <div className="header-top__block header-top__block-1">
                            <Link href="mailto:info@fud-trak77.ru">
                                <a
                                    itemProp="telephone"
                        ...
                        <nav className="header-outter__nav nav container">
                            ...
                            <Link href="tel:+74951521445">
                                <div className="nav__tel-block">
                                    ...
                                    <a className="nav__tel">8 495 152 14-45</a>
                                </div>
                            </Link>
                        </nav>
                        <div className="header-outter__bottom header-tablet">
                            <a
                                href="mailto:info@fud-trak77.ru"
